#ifndef SW_OPENSSL_TCPCLIENT_H
#define SW_OPENSSL_TCPCLIENT_H
...
static inline swSocketReturnType swTCPClientRead  (swTCPClient *client, swStaticBuffer *buffer, ssize_t *bytesRead)     { return swSSLSocketIORead    ((swSSLSocketIO *)client, buffer, bytesRead);    }
static inline swSocketReturnType swTCPClientWrite (swTCPClient *client, swStaticBuffer *buffer, ssize_t *bytesWritten)  { return swSSLSocketIOWrite   ((swSSLSocketIO *)client, buffer, bytesWritten); }
